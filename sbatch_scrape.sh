#!/bin/bash
#SBATCH --job-name=git_scrape
#SBATCH --output=logs/git_scrape_output_%A_%a.log
#SBATCH --error=logs/git_scrape_error_%A_%a.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
srun -N1 --wait=0 python -u scrape_local.py $FILE_PATH $START_INDEX $END_INDEX