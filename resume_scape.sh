...
FILE_PATH=resume_test_repos.txt
...
srun --wait=0 python -u scrape_local.py --file_path $FILE_PATH --start_index $START_INDEX --end_index $END_INDEX --resume_batch $RESUME_BATCH_ID
# else
